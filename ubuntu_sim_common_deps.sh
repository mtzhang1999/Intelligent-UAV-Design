...
sudo -H pip install --upgrade pip -i https://pypi.tuna.tsinghua.edu.cn/simple/
sudo -H pip install pandas jinja2 pyserial pyyaml -i https://pypi.tuna.tsinghua.edu.cn/simple/
# optional python tools
sudo -H pip install pyulog -i https://pypi.tuna.tsinghua.edu.cn/simple/
